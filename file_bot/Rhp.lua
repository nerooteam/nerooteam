------------------------------------------------
-- This Source Was Developed By (Rhp) @nero_TEAM0.--
--   This Is The Source Channel @nero_TEAM0 .   --
-- Rhp --
---- https://t.me/nero_TEAM0 ----
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,5189944904}  
...
if UserId == 5189944904 then
Status = true
elseif UserId == 5189944904 then
Status = true
...
if tonumber(msg.sender.user_id) == 5189944904 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5189944904 then
...
{{text =news,url = "https://t.me/vdark"}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/WqqqT}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ⇜  عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/vdark'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ⇜  عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/nero_TEAM0'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ⇜  عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local ban = LuaTele.getUser(Message_Reply.sender.user_id)
...
keyboardd.inline_keyboard = {
{
{text = '𝐅𝐀𝐖𝐀𝐙', url = "https://t.me/vdark"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
